...
const team = [
  { name: "Vedant Kharche", role: "Core Developer", initial: "V" },
  { name: "Shruti Tattapure", role: "Core Developer", initial: "S" },
  { name: "Yash Bhosale", role: "Core Developer", initial: "Y" },
  { name: "Harshwardhan Galande", role: "Core Developer", initial: "H" },
];
